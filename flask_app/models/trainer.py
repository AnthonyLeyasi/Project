...
class Trainer:
    ...
    @classmethod
    def save(cls, data):
        query = "INSERT INTO trainers (first_name, last_name, user_id, city, gym, discription, created_at, updated_at) VALUES (%(first_name)s, %(last_name)s, %(user_id)s, %(city)s, %(gym)s, %(discription)s NOW(), NOW());"
    ...
    def validate_trainer(form_data):
        is_valid = True
        query = "SELECT * FROM trainers WHERE trainer = %(trainer)s"
